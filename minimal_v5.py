...
class App(gym.Env):
    ...
    def step(self, action):
        ...
        action_cartesian = np.array([action[1] * np.cos(action[0]), action[1] * np.sin(action[0])]) # x, y Berrechnen
