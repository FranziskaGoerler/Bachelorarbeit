...
param_names = ['ACTION_SPACE_TYPE', 'OBSERVATION_SPACE_TYPE', 'REWARD_FUNCTION',
               'SCREEN_WIDTH', 'SCREEN_HEIGHT', 'N_BINS', 'N_BOTS', 'BOT_RADIUS', 'COLLISION_DISTANCE', 'UNSAFE_DISTANCE',
...
class App(gym.Env):
    ...
    def setup(self):
        ...
        robot_rng = np.random.default_rng(0)
        ...
        if CENTER_START:
            ...
            # nx = rx * (SCREEN_WIDTH - 40) + 20
            # ny = ry * (SCREEN_HEIGHT - 40) + 20
