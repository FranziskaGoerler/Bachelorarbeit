...
# LOAD_PATH = './evals/figures/final/5'
LOAD_PATH = './evals/ppo_pycking/14'
...
# file_path = LOAD_PATH + '/agent102210.0'
with open(file_path, 'rb') as f:
...
if PPO:
    ...
    agent.eval(env, eval_episodes=1000, episodes=agent_params['episodes'], train_freq=agent_params['train_freq'],
